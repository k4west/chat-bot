...
class QuizCrawling:
    ...
    def __init__(self, src="../data/quizzes.pkl"):
    ...
    def quiz_crawling(self, losted: bool = False):
        ...
        if losted:  # 놓친 문제 crawling
            new_losted = []
            df0 = pd.read_pickle(self.src)["problemId"]
...
if __name__ == "__main__":
    # 문제 크롤링
    crawled_quiz = QuizCrawling(src="../data/quizzes.pkl")
    ...
    # 문제 저장
    crawled_quiz.save_quiz("../data/quizzes.pkl")
